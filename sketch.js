...
function preload() {
  ...
  SpriteData = loadJSON("./assets/boat/broken_boat.json")
  SpriteSheet = loadImage("./assets/boat/broken_boat.png")
}
...
function setup() {
  ...
  var brokenBoatFrames = SpriteData.frames;
  for(var i = 0;i < brokenBoat.length; i++) {
